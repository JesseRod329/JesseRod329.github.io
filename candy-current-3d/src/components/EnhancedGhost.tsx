...
const EnhancedGhost: React.FC<EnhancedGhostProps> = ({ 
  position, 
  color, 
  playerPosition, 
  isPlayerPoweredUp,
  ...
  // Ghost AI - improved chase behavior
  useFrame((state, delta) => {
    ...
    // Improved AI: move towards player with some randomness
    const direction = playerPosition.clone().sub(ghostPos).normalize();
    
    // Add strategic randomness to make movement less predictable
  ...
  return (
    <group ref={bodyRef}>
      ...
      {/* Enhanced Ghost Bottom Wavy Effect */}
